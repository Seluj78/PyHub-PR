...
try:
    ...
    print("Module 'requests' is required to run this script. Please install and try again.")

from pyhub_pr._git import get_base_branch_name, get_current_branch_name


def create_pull_request(token, title, body, base, head, github_url, organisation, repository):
    headers = {
...
def main():
    parser = argparse.ArgumentParser(
        prog="github_pr", description="Create a PR"
    )
